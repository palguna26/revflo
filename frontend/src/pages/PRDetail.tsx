...
import { ExternalLink, RefreshCw, ArrowLeft, CheckCircle2, CheckCircle, XCircle, Clock, Shield, FileCode, Ban, HelpCircle, AlertOctagon, AlertTriangle } from 'lucide-react';
  ...
  <div className="flex items-start justify-between gap-4">
    <div className="space-y-3">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {/* GitHub State Badge */}
        <GitHubStateBadge
          githubState={(pr as any).github_state}
      ...
      <div className="flex items-center gap-4">
        <p className="text-sm text-muted-foreground">
          Authored by <span className="font-medium text-foreground">{pr.author}</span>
        </p>

        {/* Sync Status */}
        <SyncStatus lastSynced={(pr as any).last_synced_at} />
      </div>
    </div>
